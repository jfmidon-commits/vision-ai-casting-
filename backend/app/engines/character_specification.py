    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            "character": {
                ...
                "age_presentation": self.character.age_presentation,
            ...
            "wardrobe": {
                ...
                "tone": self.wardrobe.tone,
                "style": self.wardrobe.style,
                "accessories": self.wardrobe.accessories,
            },
            "identity_preservation": {
                "face": self.identity_preservation.face,
                "body_proportions": self.identity_preservation.body_proportions,
                "skin_tone": self.identity_preservation.skin_tone,
                "eye_color": self.identity_preservation.eye_color,
                "distinctive_features": self.identity_preservation.distinctive_features,
            },
            "environment": {
                "setting": self.environment.setting,
                "lighting": self.environment.lighting,
                "era": self.environment.era,
            },
...
class CharacterSpecificationEngine:
    ...
    BEARD_TYPES = {
        ...
        "barba curta": {"type": "short_beard", "length_days": 7},
        "barba media": {"type": "medium_beard", "length_days": 14},
        "barba longa": {"type": "long_beard", "length_days": 30},
        "barba raspada": {"type": "clean_shaven", "length_days": 0},
    ...
    WARDROBE_TYPES = {
        ...
        "esportivo": "athletic", "athletic": "athletic", "roupa esportiva": "athletic",
        "uniforme": "uniform", "uniform": "uniform", "jaleco": "uniform",
        "fantasia": "costume", "costume": "costume",
    }

    WARDROBE_TONES = {
        "escuro": "dark", "dark": "dark", "escura": "dark",
        "claro": "light", "light": "light", "clara": "light", "branco": "light", "branca": "light",
        "vibrante": "vibrant", "vibrant": "vibrant",
        "neutro": "neutral", "neutral": "neutral",
    }

    def __init__(self):
        self.specifications_generated = 0
    ...
    def _calculate_confidence(
        ...
        if character.expression != "neutral":
            score += 0.1
        if appearance.beard or appearance.hair:
            score += 0.2
        if wardrobe.type != "casual":
            score += 0.2
        if wardrobe.tone:
            score += 0.1
