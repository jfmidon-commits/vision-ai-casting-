...
# ========== VISAGISM V2 (VisagismAgent Real) ==========
# Schemas adicionados para compatibilidade com o novo pipeline hibrido.
# Os schemas completos estao em app/ai/visagism/schemas.py
# Estes sao aliases e wrappers para uso nos routers.

class VisagismAnalysisRequestV2(BaseModel):
    """Request para analise de visagismo v2."""
    photos: List[Dict[str, Any]] = Field(..., description="Lista de fotos do protocolo multifoto")
    profile_id: UUID
    analysis_types: List[str] = ["hair"]
    include_report: bool = True
    include_visualization: bool = True

class VisagismAnalysisResponseV2(BaseModel):
    """Response da analise de visagismo v2."""
    success: bool
    analysis: Optional[Dict[str, Any]] = None  # VisagismAnalysisResult como dict
